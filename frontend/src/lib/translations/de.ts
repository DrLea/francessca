...
const de: Record<TranslationKey, string> = {
  ...
  "files.downloadTranslated": "Übersetzung herunterladen",
  "files.translating": "Wird übersetzt…",
  "files.delete": "Löschen",
  "files.deleting": "Wird gelöscht…",
  "files.deleteConfirm": "Dieses Dokument löschen? Dies kann nicht rückgängig gemacht werden.",
  "files.noTextForTranslation": "Kein extrahierter Text zum Übersetzen verfügbar",
  "files.actionError": "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut.",
