...
const ro: Record<TranslationKey, string> = {
  ...
  "files.downloadTranslated": "Descarcă traducerea",
  "files.translating": "Se traduce…",
  "files.delete": "Șterge",
  "files.deleting": "Se șterge…",
  "files.deleteConfirm": "Ștergi acest document? Această acțiune nu poate fi anulată.",
  "files.noTextForTranslation": "Niciun text extras disponibil pentru traducere",
  "files.actionError": "Ceva nu a mers bine. Te rugăm să încerci din nou.",
