...
const uk: Record<TranslationKey, string> = {
  ...
  "files.downloadTranslated": "Завантажити переклад",
  "files.translating": "Переклад…",
  "files.delete": "Видалити",
  "files.deleting": "Видалення…",
  "files.deleteConfirm": "Видалити цей документ? Цю дію не можна скасувати.",
  "files.noTextForTranslation": "Немає витягнутого тексту для перекладу",
  "files.actionError": "Щось пішло не так. Спробуйте ще раз.",
