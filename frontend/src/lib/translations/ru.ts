...
const ru: Record<TranslationKey, string> = {
  ...
  "files.downloadTranslated": "Скачать перевод",
  "files.translating": "Перевод…",
  "files.delete": "Удалить",
  "files.deleting": "Удаление…",
  "files.deleteConfirm": "Удалить этот документ? Это действие нельзя отменить.",
  "files.noTextForTranslation": "Нет извлечённого текста для перевода",
  "files.actionError": "Что-то пошло не так. Попробуйте ещё раз.",
